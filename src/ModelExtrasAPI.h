...
extern "C"
{
    ...
    ME_WRAPPER void  ME_StopVehicleSounds(CVehicle *pVeh);
    ME_WRAPPER bool  ME_IsDoorChimePlaying(CVehicle *pVeh);
    ME_WRAPPER bool  ME_IsBrakePadSqueakPlaying(CVehicle *pVeh);
