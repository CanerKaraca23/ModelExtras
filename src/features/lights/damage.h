...
struct LightDamageState {
    bool isHeadlightLeftOk;
    bool isHeadlightRightOk;
    bool isFrontLeftOk;
    bool isFrontRightOk;
    bool isRearLeftOk;
    bool isRearRightOk;
    ...
    static LightDamageState Get(CVehicle* pControlVeh, CVehicle* pTowedVeh) {
        ...
        state.isFrontLeftOk = state.isHeadlightLeftOk || (pControlVeh->m_nSirenOrAlarm != 0);
        state.isFrontRightOk = state.isHeadlightRightOk || (pControlVeh->m_nSirenOrAlarm != 0);
